...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row">
      ...
      <div className="relative hidden md:block md:w-1/2 lg:w-3/4">
        <Image
          src="/login.png"
      ...
      <div className="flex w-full h-full items-center justify-center bg-background p-8 md:w-1/2 lg:w-1/4">
